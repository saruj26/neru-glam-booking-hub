...
import { bookingsApi, offersApi } from "@/lib/apiService";
import type { StoredBooking, Offer } from "@/lib/paymentUtils";
...
const SVC_SEED: ServiceData[] = [
  {
    ...
    description:
      "A fresh, youthful look perfect for daytime birthday celebrations.",
    category: "birthday",
    price: "₹2,500",
    image:
      "https://images.unsplash.com/photo-1596704017254-9b80443994d7?auto=format&fit=crop&w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1596704017254-9b80443994d7?auto=format&fit=crop&w=800&q=80",
    ],
    active: true,
  },
  {
    ...
    description:
      "Elevated makeup with shimmer and glow, perfect for evening parties.",
    category: "birthday",
    price: "₹3,500",
    image:
  ...
  },
  {
    ...
    price: "₹4,500",
    image:
      "https://images.unsplash.com/photo-1617220275046-90170ad2815f?auto=format&fit=crop&w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1617220275046-90170ad2815f?auto=format&fit=crop&w=800&q=80",
    ],
    active: true,
  },
  {
    ...
    description:
      "Classic makeup style perfect for traditional puberty ceremonies.",
    category: "puberty",
    price: "₹4,000",
    image:
      "https://images.unsplash.com/photo-1487412947147-5cdc1cdc5564?auto=format&fit=crop&w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1487412947147-5cdc1cdc5564?auto=format&fit=crop&w=800&q=80",
    ],
    active: true,
  },
  {
    ...
    description:
      "Contemporary makeup with traditional elements for a fresh take.",
    category: "puberty",
    price: "₹5,000",
    image:
      "https://images.unsplash.com/photo-1613324446652-383d8b677c7c?auto=format&fit=crop&w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1613324446652-383d8b677c7c?auto=format&fit=crop&w=800&q=80",
    ],
    active: true,
  ...
  },
  {
    ...
    description:
      "Show-stopping makeup with dramatic eyes and perfect contouring.",
    category: "reception",
    price: "₹9,000",
    image:
  ...
  },
  {
    ...
    description:
      "Classic bridal look with traditional elements and rich colors.",
    category: "wedding",
    price: "₹12,000",
    image:
      "https://images.unsplash.com/photo-1595159901089-7d0b3608515e?auto=format&fit=crop&w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1595159901089-7d0b3608515e?auto=format&fit=crop&w=800&q=80",
    ],
    active: true,
  },
  {
    ...
    description:
      "Premium bridal makeup with hair styling, draping assistance, and touch-ups.",
    category: "wedding",
    price: "₹18,000",
    image:
      "https://images.unsplash.com/photo-1607779097040-17baf87ddab0?auto=format&fit=crop&w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1607779097040-17baf87ddab0?auto=format&fit=crop&w=800&q=80",
    ],
    active: true,
  },
  {
    ...
    description:
      "Special makeup for celebrations like Diwali, Eid, Christmas, etc.",
    category: "other",
    price: "₹2,000",
    image:
...
const NOTIFS = [
  {
    ...
    body: "Your Bridal Makeup on 25 Jun at 9:00 AM is confirmed with Neru Priya.",
    time: "2 hours ago",
  },
  {
    id: 2,
    ...
    body: "Reminder: Reception Makeup on 10 Jul. Please arrive 15 min early.",
    time: "1 day ago",
  },
  {
    id: 3,
    ...
    body: "Save 25% on all services this festival season. Valid till 15 Aug.",
    time: "3 days ago",
  },
  {
    id: 4,
    ...
    body: "Celebrity makeup artist Meena Sharma has joined the Neru Beauty team!",
    time: "5 days ago",
  },
  {
    id: 5,
    type: "points",
    title: "Points Earned!",
    body: "You earned 350 loyalty points for Birthday Makeup. Total: 1,250 pts.",
    time: "1 week ago",
  },
];
...
const RECOMMENDED = [
  {
    ...
    desc: "Full bridal look with HD foundation & airbrush finish",
    price: "₹8,500",
    badge: "Popular",
  },
  {
    ...
    desc: "Glamorous evening look with expert contouring & glow",
    price: "₹6,500",
    badge: "New",
  },
  {
    id: "birthday",
    title: "Birthday Party Look",
    desc: "Fresh & vibrant party-ready look in under 2 hours",
    price: "₹3,500",
    badge: "",
  },
  {
    id: "puberty",
    title: "Puberty Ceremony Makeup",
    desc: "Traditional cultural ceremony look with accessory styling",
    price: "₹4,000",
    badge: "Trending",
  },
];
...
const StatusBadge = ({ status }: { status: string }) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold ${BADGE_CLS[key] ?? BADGE_CLS.pending}`}
    >
      <span
        className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${DOT_CLS[key] ?? DOT_CLS.pending}`}
      />
...
const SIDEBAR_BG =
  "linear-gradient(180deg,#2D1B69 0%,#5B21B6 45%,#7C3AED 80%,#8B5CF6 100%)";
    ...
    <div className="flex flex-col h-full py-6">
      <div className="flex items-center gap-3 px-6 mb-8">
        <div
          ...
          style={{
            background: "rgba(212,165,63,0.25)",
            border: "1.5px solid rgba(212,165,63,0.5)",
          }}
        >
        ...
        <div className="leading-none">
          ...
          <p className="text-white/40 text-[9px] tracking-[0.2em] uppercase mt-0.5">
            Customer Portal
          </p>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              {id === "notifications" && unread > 0 && (
                <span className="ml-auto w-5 h-5 rounded-full bg-pink-500 text-white text-[10px] font-bold flex items-center justify-center">
                  {unread}
                </span>
              )}
            </button>
...
const CustomerDashboard = () => {
  ...
  const [isDark, setIsDark] = useState(
    () => localStorage.getItem("neru-theme") === "dark",
  );

  /* ── Bookings state ── */
  const [bSearch, setBSearch] = useState("");
  const [bTab, setBTab] = useState<
  ...
  const [svcTab, setSvcTab] = useState<
    "birthday" | "puberty" | "reception" | "wedding" | "other"
  >("birthday");
  ...
  useEffect(() => {
    getActiveTipsAsync()
      .then((tips) => {
        setTipsList(tips);
        setFeatTips(tips.filter((t) => t.featured).slice(0, 3));
      })
      .catch(() => {});
  }, []);
  ...
  useEffect(() => {
    if (currentUser.email) {
      bookingsApi
        .getByCustomer(currentUser.email)
        .then(setRealBookings)
        .catch(() => {});
    }
  }, [currentUser.email]);
  ...
  useEffect(() => {
    const handleClick = (e: MouseEvent) => {
      if (
        ...
        !desktopNotifRef.current.contains(e.target as Node)
      )
  ...
  const filteredBookings = useMemo(() => {
    ...
    if (bTab === "active")
      b = b.filter((x) =>
        ["confirmed", "pending_payment", "partially_paid"].includes(x.status),
      );
  ...
  const activeBookings = realBookings.filter((b) =>
    ["confirmed", "pending_payment", "partially_paid"].includes(b.status),
  );
  const completedCount = realBookings.filter(
        ...
        <div className="flex items-center gap-3">
          {unread > 0 && (
            <button
              ...
              className="text-[11px] font-semibold text-neru-purple hover:underline"
            >
              Mark all read
            </button>
          )}
      ...
      <div className="space-y-2">
        {NOTIFS.map((n) => {
          ...
          return (
            ...
            >
              <div
                className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${cfg.cls}`}
              >
                <Icon size={13} />
              </div>
              <div className="flex-1 min-w-0">
                <p
                  className={`text-xs font-bold ${isRead ? "text-gray-600" : "text-neru-darkGray"}`}
                >
                  {n.title}
                </p>
              ...
              {!isRead && (
                <span className="w-2 h-2 rounded-full bg-neru-purple flex-shrink-0 mt-1" />
              )}
            </div>
          );
        })}
    ...
    <div className="py-2">
      <div className="px-4 py-3 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="font-bold text-sm text-neru-darkGray truncate">
              {currentUser.name}
            </p>
        ...
        <div className="flex gap-1.5 mt-2.5">
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full text-amber-700 bg-amber-50 flex items-center gap-1">
            <Crown size={9} />
            {currentUser.level}
          </span>
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full text-purple-700 bg-purple-50">
      ...
      {(
        ...
        >
          <Icon size={14} className="text-neru-purple" />
          {label}
        </button>
      ))}
  ...
  const renderOverview = () => (
    <div className="space-y-6">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg,#3B0764 0%,#6D28D9 50%,#7C3AED 80%,#B45309 100%)",
        }}
      >
        <div
        ...
        />
        <div
          className="absolute -bottom-16 -left-10 w-56 h-56 rounded-full opacity-10"
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <div
                ...
                style={{
                  background: "linear-gradient(135deg,#D4A53F,#F59E0B)",
                }}
              >
                {userInitials}
              </div>
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              to="/booking"
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold text-neru-darkGray hover:opacity-90 transition-all shadow-lg"
              style={{ background: "linear-gradient(135deg,#D4A53F,#F59E0B)" }}
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold text-white bg-white/15 hover:bg-white/25 transition-all"
            >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={label}
            className="rounded-2xl p-3.5 text-white shadow-lg hover:-translate-y-0.5 hover:shadow-xl transition-all duration-200"
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3
            className="font-bold text-neru-darkGray text-lg"
            style={{ fontFamily: "'Playfair Display',serif" }}
          >
            Upcoming Appointments
          </h3>
          <button
            ...
            className="text-neru-purple text-sm font-medium hover:underline flex items-center gap-1"
          >
        ...
        {activeBookings.length === 0 ? (
          <div className="bg-white rounded-2xl p-8 text-center border border-gray-100">
            ...
            <p className="text-gray-400 text-sm">
              ...
              <button
                onClick={() => nav("bookings")}
                className="text-neru-purple font-medium hover:underline"
              >
                Book one now!
              </button>
            </p>
            ...
            {activeBookings.slice(0, 2).map((b) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <p className="font-bold text-neru-darkGray text-sm">
                      {b.service.name}
                    </p>
                ...
                <div className="space-y-1.5 text-xs text-gray-500">
                  <div className="flex items-center gap-2">
                    <Calendar size={12} className="text-neru-purple" />
                    {b.date} · {b.time}
                  </div>
                  <div className="flex items-center gap-2">
                    <Tag size={12} className="text-neru-purple" />₹
                    {b.pricing.finalPrice.toLocaleString()}
                  </div>
                </div>
              </div>
            ))}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-50">
                  ...
                  <th className="text-left px-5 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider hidden sm:table-cell">
                    Date
                  </th>
                  <th className="text-left px-5 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">
                    Status
                  </th>
                  <th className="text-right px-5 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider hidden md:table-cell">
                    Amount
                  </th>
                </tr>
              </thead>
                ...
                {realBookings.length === 0 ? (
                  <tr>
                    ...
                    >
                      ...
                      <Link
                        to="/booking"
                        className="text-neru-purple font-semibold hover:underline"
                      >
                  ...
                  realBookings.slice(0, 4).map((b, i) => (
                    <tr
                      key={b.bookingId ?? b.id}
                      className={`hover:bg-gray-50 transition-colors ${i < 3 ? "border-b border-gray-50" : ""}`}
                    >
                      <td className="px-5 py-4">
                        <p className="font-semibold text-neru-darkGray text-xs">
                          {b.service.name}
                        </p>
                      ...
                      <td className="px-5 py-4 text-right text-xs font-semibold text-neru-darkGray hidden md:table-cell">
                        ₹{b.pricing.finalPrice.toLocaleString()}
                      </td>
                    </tr>
                  ))
      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-neru-darkGray">
        ...
        <div className="flex items-center gap-4">
          <div>
            <p className="text-2xl font-extrabold text-neru-purple">
          ...
          <div className="flex-1">
            <div className="flex justify-between text-xs text-gray-400 mb-1">
              ...
              <span>
                {currentUser.points}/{currentUser.pointsForNext}
              </span>
            </div>
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${Math.min((currentUser.points / currentUser.pointsForNext) * 100, 100)}%`,
                  background: "linear-gradient(90deg,#7C3AED,#D4A53F)",
                }}
              />
            </div>
            <p className="text-[10px] text-gray-400 mt-1">
              {currentUser.pointsForNext - currentUser.points} more points to
              reach {currentUser.nextLevel}
            </p>
          </div>
        </div>
      </div>
  ...
  const renderBookings = () => (
    <div className="space-y-5">
      <div>
        <h2
          className="text-2xl font-extrabold text-neru-darkGray"
          style={{ fontFamily: "'Playfair Display',serif" }}
        >
          My Bookings
        </h2>
        <p className="text-gray-500 text-sm mt-1">
          Track, manage and review all your beauty appointments
        </p>
      </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    <h4 className="font-bold text-neru-darkGray">
                      {b.service.name}
                    </h4>
                    <StatusBadge status={b.status} />
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-4 gap-y-1.5 text-xs text-gray-500">
                    <div className="flex items-center gap-1.5">
                      <Calendar size={11} className="text-neru-purple" />
                      <span>
                        Booked:{" "}
                        {b.createdAt
                    ...
                    <div className="flex items-center gap-1.5">
                      <CalendarCheck size={11} className="text-neru-purple" />
                      <span>Appt: {b.date}</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <Clock size={11} className="text-neru-purple" />
                      <span>{b.time}</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <User size={11} className="text-neru-purple" />
                      <span>TBA</span>
                    </div>
                  </div>
                </div>
                <div className="flex sm:flex-col items-center sm:items-end gap-3 flex-shrink-0">
                  <p className="text-lg font-extrabold text-neru-darkGray">
                    ₹{b.pricing.finalPrice.toLocaleString()}
                  </p>
                    ...
                    <button
                      onClick={() =>
                        toast({
                          ...
                          description: `${b.service.name} on ${b.date} at ${b.time}. Amount: ₹${b.pricing.finalPrice.toLocaleString()}`,
                        })
                      }
                      ...
                      <button
                        onClick={() =>
                          toast({
                            ...
                            description:
                              "Your reschedule request has been sent. We'll contact you shortly.",
                          })
                        }
    ...
    <div className="space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {activeOffers.length === 0 ? (
          ...
          activeOffers.map((o) => {
            const accent = (o as any).accent ?? "#7C3AED";
            const tag = (o as any).tag ?? o.name.split(" ")[0];
            const pct =
              o.discountType === "percentage"
                ? `${o.discountValue}%`
                : `₹${o.discountValue}`;
            const expiry = o.endDate
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <h3 className="font-bold text-neru-darkGray">{o.name}</h3>
                    </div>
  ...
  const renderLoyalty = () => {
    const pct = Math.round(
      Math.min((currentUser.points / currentUser.pointsForNext) * 100, 100),
    );
    const levels = [
      {
        name: "Silver",
        range: "0–500",
        perks: ["5% off all services", "Birthday offer", "Priority booking"],
        color: "#64748B",
        active: currentUser.level === "Silver",
      },
      {
        name: "Gold",
        range: "500–2000",
        perks: [
          ...
          "Dedicated beautician",
        ],
        color: "#D4A53F",
        active: currentUser.level === "Gold",
      },
      {
        name: "Platinum",
        range: "2000+",
        ...
        color: "#7C3AED",
        active: currentUser.level === "Platinum",
      },
    ];
    return (
      <div className="space-y-5">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Your beauty journey, beautifully rewarded
          </p>
        </div>
        <div
          className="rounded-2xl p-6 relative overflow-hidden"
          style={{
            background: "linear-gradient(135deg,#3B0764,#6D28D9,#B45309)",
          }}
        >
          <div
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {levels.map((lv) => (
            <div
              key={lv.name}
              className={`rounded-2xl p-5 border-2 transition-all ${lv.active ? "shadow-lg" : "border-gray-100"}`}
              style={{
                borderColor: lv.active ? lv.color : undefined,
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-sm" style={{ color: lv.color }}>
                  {lv.name}
                </span>
                {lv.active && (
                  <span
  ...
  const renderRecommended = () => (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          Handpicked services based on your beauty journey
        </p>
      </div>
      <div className="grid sm:grid-cols-2 gap-4">
        {RECOMMENDED.map((r) => (
          ...
          >
            <div
              ...
              style={{
                background: isDark
                  ? "linear-gradient(135deg,#1e1040,#2a1560)"
                  : "linear-gradient(135deg,#F3E8FF,#FDF4FF)",
              }}
            >
              <Sparkles
                size={40}
                className="text-neru-purple/20 group-hover:scale-110 transition-transform duration-300"
              />
              {r.badge && (
                <span
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                <p className="font-extrabold text-neru-purple text-lg">
                  {r.price}
                </p>
                <Link
                  to="/booking"
  ...
  const renderTips = () => {
    ...
    const cs = (cat: string) =>
      CAT_COLORS[cat] ?? { bg: "#F3F4F6", text: "#374151" };
      ...
      <div className="space-y-5">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Expert beauty secrets from our professional artists
            </p>
          </div>
          <Link
            to="/beauty-tips"
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {featTips.map((tip) => {
              ...
              return (
                <Link
                  key={tip.id}
                  to={`/beauty-tips/${tip.tipId || tip.id}`}
                ...
                >
                  ...
                  <div className="relative z-10 mt-auto p-5">
                    ...
                    <h3 className="text-white font-extrabold text-sm leading-snug line-clamp-2 mb-1">
                      {tip.title}
                    </h3>
        ...
        {displayList.length === 0 ? (
          <div className="bg-white rounded-2xl p-10 text-center border border-gray-100">
            ...
            <p className="text-gray-400 text-sm">
              No beauty tips yet. Check back soon!
            </p>
          </div>
        ) : (
        ...
        >
          ...
          <p className="text-white/70 text-xs mb-4">
            Our full library has tips on skincare, bridal, festive looks and
            more
          </p>
          <Link
            to="/beauty-tips"
      ...
      <div className="space-y-3">
        {NOTIFS.map((n) => {
          ...
          return (
            ...
            >
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${cfg.cls}`}
              >
                <Icon size={16} />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <p
                    className={`text-sm font-bold ${isRead ? "text-gray-700" : "text-neru-darkGray"}`}
                  >
                    {n.title}
                  </p>
                  {!isRead && (
                    <span className="w-2 h-2 rounded-full bg-neru-purple flex-shrink-0" />
                  )}
                </div>
  ...
  const renderProfile = () => (
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          <div
            ...
            style={{ background: "linear-gradient(135deg,#6D28D9,#D4A53F)" }}
          >
            {userInitials}
          </div>
          <div className="flex-1 text-center sm:text-left">
            <h3
              className="font-extrabold text-xl text-neru-darkGray"
              style={{ fontFamily: "'Playfair Display',serif" }}
            >
              {profileForm.name}
            </h3>
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-2 mt-2">
              <span className="text-xs font-semibold px-3 py-1 rounded-full text-amber-700 bg-amber-50 flex items-center gap-1">
                <Crown size={10} />
                {currentUser.level} Member
              </span>
              <span className="text-xs font-semibold px-3 py-1 rounded-full text-purple-700 bg-purple-50 flex items-center gap-1">
                <Star size={10} />
                {currentUser.points.toLocaleString()} pts
              </span>
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
        <h4 className="font-bold text-neru-darkGray mb-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-purple-50 flex items-center justify-center">
              <Key size={16} className="text-neru-purple" />
            </div>
            <div>
              <p className="font-bold text-neru-darkGray text-sm">
                Password & Security
      ...
      <div className="bg-red-50 rounded-2xl p-5 border border-red-100">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-red-600 bg-red-100 hover:bg-red-200 transition-colors"
          >
            <LogOut size={14} /> Sign Out
          </button>
        </div>
  ...
  const renderServices = () => {
    const tabServices = allServices.filter(
      (s) => s.active && s.category === svcTab,
    );
    ...
    return (
      <div className="space-y-5">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Browse all beauty services — click any card to see full details and
            book instantly
          </p>
        </div>
        ...
        {/* Category tabs */}
        <div
          className="bg-white rounded-2xl border border-gray-100 shadow-sm p-1.5 flex gap-1 overflow-x-auto"
          style={{ scrollbarWidth: "none" }}
        >
          {SVC_TABS.map((t) => (
            <button
              key={t.key}
              onClick={() => setSvcTab(t.key)}
                  ...
                  <div className="h-56 overflow-hidden relative">
                    {svc.image ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-purple-50 to-pink-50 flex items-center justify-center">
                        <Image size={36} className="text-purple-200" />
                      </div>
                    )}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
  ...
  return (
    <div
      ...
      style={{
        background: isDark ? "#0f0f1a" : "#F8F5FF",
    ...
    >
      ...
      >
        <button
          onClick={() => setMenuOpen(false)}
          className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 text-white hover:bg-white/20 transition-colors"
        >
          <X size={16} />
        </button>
        <SidebarNav
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        >
          {/* Top row */}
          <div
            className={`flex items-center gap-2 px-4 transition-all duration-300 ${scrolled ? "h-12" : "h-14"}`}
          >
            {/* Logo + name */}
            <div
              className={`flex items-center gap-2 flex-1 min-w-0 transition-all duration-300 origin-left ${scrolled ? "scale-[0.92]" : "scale-100"}`}
            >
              <div
              ...
              <div className="min-w-0">
                <p
                  className="font-bold text-neru-darkGray text-sm leading-none"
                  style={{ fontFamily: "'Playfair Display',serif" }}
                >
                  Neru Beauty
                </p>
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              ...
              <button
                ...
                style={{
                  ...
                  background: isDark ? "rgba(253,211,77,0.1)" : undefined,
                }}
            ...
            <div className="flex items-center justify-between px-4 pb-2.5">
              <div>
                <p className="text-sm font-bold text-neru-darkGray leading-tight">
                  Welcome Back,{" "}
                  <span style={{ color: "#7C3AED" }}>{firstName}</span> ✨
                </p>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/booking"
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold text-white shadow-sm hover:opacity-90 transition-all"
              style={{ background: "linear-gradient(135deg,#7C3AED,#8B5CF6)" }}
            >
            ...
            {(
              ...
              return (
                ...
                >
                  ...
                  />
                  <span
                    className={`text-[10px] font-semibold leading-none ${isActive ? "text-neru-purple" : isDark ? "text-gray-500" : "text-gray-400"}`}
                  >
                    {label}
                  </span>
                </button>
